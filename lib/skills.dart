        ...
        child: Center(
          child: Column(
            children: [
              ...
              WordCloudView(
                  data: wcdata,
                  mapwidth: MediaQuery.of(context).size.width>1000? MediaQuery.of(context).size.width*.7: MediaQuery.of(context).size.width* 0.9,
                  mapheight: MediaQuery.of(context).size.height * 0.6,
